...
本体系的确定性比较见 [comparisons.json](../../../../../../assets/literature_reproduction/r2_r5_analysis_20260910/runs/comparisons.json)。
...
[分析清单与代码哈希](../../../../../../assets/literature_reproduction/r2_r5_analysis_20260910/runs/manifest.json)；全部原始文件哈希在逐 run 的 metrics.json 中重新核对。分析工具采用 Karpathy Guidelines 和 Scientific Agent Skills 的原始数据保留、相关性与可视化原则。[^1]
