...
逐项作业号、数组索引、命令、依赖和时间申请见 [submission.json](../../../../../conf/archive/frozen/zero_field_gomonay/20260911_040025/submission.json)。
...
- 完成 [事实盘点](inventory.md) 和 [逐文件哈希、环境与历史退出码记录](../../../../../assets/research/runs/zero_field_program/20260911_040025/inventory.json)
...
| CPU / GPU 实际热浴接口 | 各 1,000,032 分量，注册检查通过 | [CPU](../../../../../assets/research/runs/zero_field_program/20260911_040025/bath_cpu.json)、[GPU](../../../../../assets/research/runs/zero_field_program/20260911_040025/bath_cuda.json) |
| 代表性计时 | 36 组完成，包含压缩/写盘；积分组至少 10,000 步，BVP 使用实际延拓工作单元 | [timing](../../../../../output/zero_field_program/20260911_040025/timing) |
...
依据见 [资源估计](../../../../../assets/research/runs/zero_field_program/20260911_040025/resource_estimate.json) 与 [冻结 manifest](../../../../../conf/archive/frozen/zero_field_gomonay/20260911_040025/manifest.json)。
...
详细阶段状态、明确未实现项、历史预检失败原因和全部作业索引见 [plan_state.json](../../../../../assets/research/runs/zero_field_program/20260911_040025/plan_state.json)。
