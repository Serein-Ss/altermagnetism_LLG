...
from altermagnetism_LLG.scripts.model.sphere import sample_reference_path, sphere_exp  # noqa: E402
...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "--output",
        type=Path,
        default=ROOT / "data" / "generated" / "inference" / "sample.npz",
    )
    return p
...
def main() -> None:
    ...
    args.output = generated_path(args.output)
