...
def arguments(paper, modes):
    ...
    parser.add_argument('--config',type=Path,default=ROOT/'conf/literature_reproduction/physics'/f'{paper}.yaml')
...
def prepare(args,paper):
    ...
    out=output_root/'assets/literature_reproduction'/paper/args.run_id
