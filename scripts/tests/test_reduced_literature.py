...
CONFIG=ROOT/'conf/literature_reproduction/physics/nishino_miyashita_2015.yaml'


@pytest.mark.parametrize('path',sorted((ROOT/'conf/literature_reproduction/physics').glob('*.yaml')),ids=lambda x:x.stem)
