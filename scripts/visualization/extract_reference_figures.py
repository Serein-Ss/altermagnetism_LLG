...
OUT_DIR = ROOT / "assets" / "literature" / "literature_validation" / "reference"


def main() -> None:
    OUT_DIR.mkdir(parents=True, exist_ok=True)
    source = ROOT / "data" / "literature" / "literature_validation" / "Gomonay_2024_main.pdf"
    with tempfile.TemporaryDirectory(prefix="gomonay_fig2_") as tmp:
        ...
        figure2.save(asset_path(OUT_DIR / "gomonay_2024_fig2.png"))
