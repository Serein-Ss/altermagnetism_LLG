...
def main() -> None:
    ...
    p.add_argument("--input", type=Path,
                   default=ROOT / 'data/literature_reproduction/gomonay_2024/raw/legacy_before_reduced_20260909/spinwave_trajectory.npz' )
    p.add_argument("--output", type=Path,
                   default=ROOT / 'assets/literature_reproduction/gomonay_2024/legacy_before_reduced_20260909/figures/spinwave_reproduction.png' )
    args = p.parse_args()
