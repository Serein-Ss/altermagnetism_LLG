...
from altermagnetism_LLG.scripts.visualization.model_plots import _plot_histograms, _plot_paths, _animate_pair
...
def main() -> None:
    ...
    trajectory_target = generated_path(args.output_dir / "generated_trajectories.h5")
    ...
    with h5py.File(args.input, "r", swmr=True) as source:
        ...
        output_h5 = generated_path(args.output_dir / "generated_trajectories.h5")
        if output_h5.exists():
            output_h5.unlink()
        condition_reports = []
        animation_inputs = {}
