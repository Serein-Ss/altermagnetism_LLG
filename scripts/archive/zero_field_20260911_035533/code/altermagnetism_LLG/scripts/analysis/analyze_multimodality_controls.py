...
FOLDERS = {
    "altermagnet_dt_0.10_fs": ROOT / "data" / "research" / "multimodality_validation",
    "altermagnet_dt_0.05_fs": ROOT / "data" / "research" / "multimodality_validation_dt0p05",
    "afm_control_jtilde_0": ROOT / "data" / "research" / "multimodality_afm_control",
}
...
def main() -> None:
    ...
    target = ROOT / "data" / "research" / "multimodality_control_comparison.json"
