...
OLD_CONFIG = ROOT/'conf/archive/frozen/zero_field_gomonay/20260911_040025/014.yaml'
FILES = ['scripts/workflow/bauer_revision4.py', 'scripts/analysis/bauer_revision4_audit.py',
         ...
         'scripts/tests/conftest.py', 'conf/research/models/bauer_path/draft.yaml', 'slurm/bauer_revision4.sbatch']
...
def prepare():
    ...
    out = ROOT/'assets/literature_reproduction/bauer_2011/runs/bauer_revision4'/run_id
    frozen = ROOT/'conf/archive/frozen/bauer_revision4'/run_id
