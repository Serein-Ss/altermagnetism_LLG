...
def main():
    ...
    config_dir=ROOT/'conf/archive/frozen'/PAPER/campaign;config_dir.mkdir(parents=True)
    output=ROOT/'assets/literature_reproduction'/PAPER/campaign;output.mkdir(parents=True,exist_ok=True)
