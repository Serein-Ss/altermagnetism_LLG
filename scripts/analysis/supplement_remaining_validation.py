...
def main():
    aid='r2_r5_analysis_20260910';out=ROOT/'assets/literature_reproduction'/aid
    ...
    for r in rows:
        ...
        if r['protocol'] in ('spinwave','control'):
            ...
            with np.load(path,allow_pickle=False) as z:
                ...
                reduced=load_runtime(ROOT/'conf/literature_reproduction/physics/gomonay_2024.yaml').reduced
